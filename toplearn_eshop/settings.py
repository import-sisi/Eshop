...
SECRET_KEY = 'django-insecure-*--jhxjwmg59+o(gnesrh((pgawaa3hza625qpy1^t&#ocgfte'
...
ROOT_URLCONF = 'toplearn_eshop.urls'
...
WSGI_APPLICATION = 'toplearn_eshop.wsgi.application'
