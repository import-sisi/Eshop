...
class ProductsManager(models.Manager):
    ...
    def search(self, query):
        ...
        return self.get_queryset().filter(lookup, active=True).distinct()    #emkan rezalt hay yeksan ra hazf mikone
...
class Product(models.Model):
    ...
    visite_count = models.IntegerField(default=0, verbose_name='تعداد بازدید')
